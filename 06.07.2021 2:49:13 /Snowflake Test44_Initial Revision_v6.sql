...
(
 ...
 CONSTRAINT FK_76 FOREIGN KEY ( CustomerId, OrderId, DateId, SupplierId_1, ProductId ) REFERENCES Fact_Customer_Orders ( CustomerId, OrderId, DateId, SupplierId, ProductId )
)
STAGE_FILE_FORMAT = 
(
 FORMAT_NAME = 'CsvFileFormat'
