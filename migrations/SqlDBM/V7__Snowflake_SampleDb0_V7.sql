...
-- ************************************** Schema_79.Dim_Customer
CREATE TRANSIENT TABLE Schema_79.Dim_Customer
(
...
(
 ...
 CONSTRAINT FK_Fact_Customer_Orders_CustomerId FOREIGN KEY ( CustomerId ) REFERENCES Schema_79.Dim_Customer ( CustomerId ),
